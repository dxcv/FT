...
import pandas as pd
import self_lib.factor_test as ft
...
#    IC = pd.DataFrame(index=store['btic_m_index'])
    ...
    plt.title('Cumulated Return of ' + class_name + ' Factors')
    plt.savefig('Cumulated Return of ' + class_name + ' Factors' + '.png', bbox_inches='tight')
    ...
    plt.savefig('Annual Return of ' + class_name + ' Factors' + '.png', bbox_inches='tight')

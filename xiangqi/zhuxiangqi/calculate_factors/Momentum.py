...
import self_lib.data_clean as dc
import self_lib.class_test as ct

store = pd.HDFStore(r'D:\zht\database\quantDb\internship\FT\xiangqi\factors\test_data_new.h5')
